...
const SuperAdminLayout = ({ children }) => {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      <aside data-testid="super-admin-sidebar" className="sidebar" style={{ width: '260px', padding: '1.5rem', display: 'flex', flexDirection: 'column' }}>
        ...
        <button data-testid="logout-button" onClick={logout} className="sidebar-link" style={{ width: '100%', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', fontFamily: 'inherit', fontSize: 'inherit' }}>
